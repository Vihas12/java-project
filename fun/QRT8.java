 ...
 */
public class QRT8 extends javax.swing.JFrame {

    /**
     * Creates new form QRT8
     */
    public QRT8() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 1550, 730));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            setVisible(false);
            new QRT18().toFront();
            new QRT18().setState(java.awt.Frame.NORMAL);
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QRT8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
